...
try {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '
               <br><br> <button class="edit-btn"><span>Editar Post</span></button> 
               <button class="delete-btn"><span>Borrar Post</span></button> 
    ...
    foreach ($posts as $post) {
        ...
        echo '
           <br><br> <button class="edit-btn"><span>Editar Post</span><span></span></button> 
           <button class="delete-btn"><span>Borrar Post</span><span></span></button> 
